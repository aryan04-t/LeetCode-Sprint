...
// TAGS: [RATING: 1947], [MEDIUM], [MOST OPTIMAL], [2D ARRAY], [GREEDY], [MINIMIZING], [BIT MANIPULATION], [BITWISE OR PROPERTIES], [BITWISE AND PROPERTIES], [BIT MASKING], [INTUITION INVERSION], [BIT BY BIT GREEDY ANSWER CONSTRUCTION] 
...
class Solution {
public:
    bool checkIsFreezingIthBitPossible (
    ...
    int minimumOR(vector<vector<int>>& grid) {
        ...
        for (int shift = 30; shift >= 0; shift--) {
            ...
            bool isFreezingIthBitPossible = checkIsFreezingIthBitPossible(
                grid, 
                newFrozenZeroes
            );
