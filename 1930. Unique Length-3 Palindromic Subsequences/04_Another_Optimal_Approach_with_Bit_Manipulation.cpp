...
// TAGS: [RATING: 1533], [MEDIUM], [OPTIMAL], [STRING], [SUBSEQUENCE], [PALINDROME], [HASH VECTOR], [LAST OCCURRENCE PRECOMPUTATION], [FIRST OCCURRENCE PRECOMPUTATION], [BIT MANIPULATION], [CHARACTER BOUND OPTIMIZATION], [INTUITION INVERSION] 
