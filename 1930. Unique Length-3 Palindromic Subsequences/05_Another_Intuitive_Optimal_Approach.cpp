...
// TAGS: [RATING: 1533], [MEDIUM], [OPTIMAL], [STRING], [SUBSEQUENCE], [PALINDROME], [HASH VECTOR], [HASH SET], [TRACKING SEEN CHARACTERS OF ALPHABET], [CHARACTER BOUND OPTIMIZATION], [INTUITION INVERSION] 
